...
local open = false 
local pizzaDeTesMort = RageUI.CreateMenu('~y~Gar~g~age', '~g~Interaction')
pizzaDeTesMort.Display.Header = true 
pizzaDeTesMort.Closed = function()
  open = false
end

function OpenTesMortpizza()
     if open then 
         open = false
         RageUI.Visible(pizzaDeTesMort, false)
         return
     else
         open = true 
         RageUI.Visible(pizzaDeTesMort, true)
         CreateThread(function()
         while open do 
            RageUI.IsVisible(pizzaDeTesMort,function() 
              ...
              RageUI.Button("Ranger le véhicule", nil, {RightLabel = "→→"}, true , {
                ...
                RageUI.Button("Camion de Pizza", nil, {RightLabel = "→→"}, true , {
                    onSelected = function()
                ...
                RageUI.Button("Bifta Pizza", nil, {RightLabel = "→→"}, true , {
                    onSelected = function()
...
Citizen.CreateThread(function()
  ...
  local blip = AddBlipForCoord(288.3, -978.06, 29.43) 

  SetBlipSprite (blip, 267) -- Model du blip
  ...
  AddTextComponentSubstringPlayerName('Pizza') -- Nom du blip
