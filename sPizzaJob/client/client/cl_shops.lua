	...
	if open then 
		...
		while open do 
		   RageUI.IsVisible(mainMenu,function() 
			...
			RageUI.Button("Pizza 2 viandes Froid", "Sert à faire un pizza 2 viandes", {RightLabel = "~g~25$"}, true , {
				onSelected = function()
					TriggerServerEvent('aurezia:Buypizzafroid2')
				end
			})


			RageUI.Button("Pizza 3 viandes Froid", "Sert à faire un pizza 3 viandes", {RightLabel = "~g~35$"}, true , {
				onSelected = function()
					TriggerServerEvent('aurezia:Buypizzafroid3')
				end
			})

			RageUI.Button("Pizza XLL", "Sert à faire un pizza XLL", {RightLabel = "~g~45$"}, true , {
				onSelected = function()
					TriggerServerEvent('aurezia:Buypizzafroidxll')
				end
			})
